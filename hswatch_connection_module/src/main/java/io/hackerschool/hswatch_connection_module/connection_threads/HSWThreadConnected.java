...
//        this.hswService.setFlagReconnection(false);
    ...
    public void sendListOfStrings(
            @NonNull String messageReceived,
            @NonNull Iterable<String> callbackResponse
    ) {
        try {
    ...
    public void sendListOfStrings(
            @NonNull String messageReceived,
            @NonNull String[] callbackResponse
    ) {
        sendListOfStrings(messageReceived, Arrays.asList(callbackResponse));
    }
