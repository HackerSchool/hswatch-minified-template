...
import io.hackerschool.hswatch_connection_module.R;
...
public class HSWService extends Service {
        ...
        public void onReceive(Context context, @NonNull Intent intent) {
            ...
            switch (action) {
                ...
                case HSWFlag.HSW_KEEP_CONECTION_FROM_EXTERNAL:
                    ...
                    break;
                case HSWFlag.HSW_NOTIFICATION_RECEIVED:
                    String[] notificationElementsArray = intent
                            .getStringArrayExtra(HSWFlag.HSW_BROADCAST_RECEIVER_EXTRA);
                    hswThreadConnected.sendListOfStrings("NOT", notificationElementsArray);
                default:break;
            }
        }
    };
    ...
    private void registerBroadCast() {
        ...
        intentFilter.addAction(HSWFlag.HSW_NOTIFICATION_RECEIVED);
